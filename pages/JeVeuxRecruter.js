...
const JeVeuxRecruter = () => {
  const reviews = [{
    ...
    review: "Nous avons intégré Zineb à l'équipe il y a maintenant 6 mois. Tout a été rendu facile par Entourage et les équipes de travail sont très satisfaites.",
    role: "Directeur RH chez Sanofi"
  }, {
    author: "Stéphane Joli",
    colorClass: "",
    picture: "/static/img/arthur.png",
    review: "Mohamed s'est fondu dans le groupe en un clin d'oeil, tout le monde a l'impression qu'il est là depuis 10 ans.",
        ...
        <div data-uk-grid className="uk-child-width-expand@s">
          <div>
            <div className="uk-width-5-6">
              <h3 className="uk-text-bold"><span className="uk-text-primary">LinkedOut plebiscité</span> par les recruteurs...</h3>
              <p>
