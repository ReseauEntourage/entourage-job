...
import { HelpingCard, ReviewCard, ScaleCard } from '../components/cards';
...
const cardsCoupsDePouce = [
  [
    {
      title: "Vous connaissez une personne en difficulté ? Entourage vous accompagne dans les démarches",
      description: "Vous n'êtes pas seul ! Entourage vous donne les outils pour soutenir efficacement une personne dans sa recherche professionnelle et dans sa prise de poste.",
    ...
    {
      title: "Encore un autre texte ? Entourage vous accompagne dans les démarches",
      description: "Vous n'êtes pas seul ! Entourage vous donne les outils pour soutenir efficacement une personne dans sa recherche professionnelle et dans sa prise de poste.",
...
const coupsDePouce = [{
  ...
  description: "LinkedOut cherche à recruter des bénévoles dont le rôle sera d'accompagner les personnes dans leur recherche d'emploi.",
  cards: cardsCoupsDePouce[0]
},{
  title: "Je suis un acteur du milieu associatif",
  description: "Entourage cherche à construire son dispositif en collaboration avec d'autres acteurs de l'insertion ayant des expertises complémentaires. Contactez-nous pour rejoindre le projet ou apporter votre savoir-faire",
  cards: cardsCoupsDePouce[1]
},{
  title: "Je suis un travailleur social",
  description: "Contactez-nous si une personne que vous accompagnez vous semble pouvoir bénéficier du programme LinkedOut, que vous voulez apprendre à rédiger des CVs selon le modèle LinkedOut pour recevoir de l'aide dans les démarches de recherche d'emploi",
  ...
  <Fragment>
    ...
    <Section id="aider2">
      <h2 className="uk-text-bold uk-margin-large-bottom uk-width-3-5@m uk-width-4-5@s">
        Il n'y a pas de petit coup de pouce.<br/>
      ...
      <div data-uk-grid className="uk-child-width-1-2@m uk-child-width-2-3@s">
        <div>
          <div className="uk-width-5-6">
            <ul data-uk-accordion="collapsible: false" data-uk-switcher="connect: .switcher-container">
              {coupsDePouce.map((coupDePouce, index) => (
                <li key={index}>
                  <a className="uk-accordion-title" href="#">{coupDePouce.title}</a>
              ...
              <li key={index}>
                <div>
                  {coupDePouce.cards.map((card, index2) => (
                    <div key={index2} className="uk-card uk-card-small uk-card-default uk-card-body">
