export default {
  strategy: [
    ...
    },
    {
      ...
      answer: 'LinkedOut c’est un tremplin vers l’inclusion : pour les entreprises qui cherchent à recruter des profils variés, pour les candidats qui pourront s’épanouir dans leur travail, et pour nous toutes et tous, qui pouvons agir simplement, en partageant un CV.'
    },
    {
      key: 'tbwa',
      title: 'TBWA',
    ...
    },
    {
      ...
      answer: 'Randstad apporte son expertise RH et sa parfaite connaissance des bassins d’emploi, pour structurer et sécuriser les parcours des candidats LinkedOut vers l’emploi durable : de l’accueil  à l’intégration et de l’accompagnement au maintien en emploi.'
    },
    {
      key: 'pic',
      bis: true,
      title: 'L’appel à projets « 100 % Inclusion – La fabrique de la remobilisation » du Plan d’investissement dans les compétences',
      desc: 'Pour accompagner la transformation du système de formation portée par la loi pour la liberté de choisir son avenir professionnel et construire une société de compétences inclusive et compétitive, le plan d’investissement dans les compétences soutient l’expérimentation dans le domaine de la montée en compétences, de la valorisation des compétences et de l’accès à l’emploi durable.\n' +
        'L’appel à projets « 100 % Inclusion – La fabrique de la remobilisation » vise à expérimenter des parcours intégrés, allant du repérage et de la remobilisation à l’emploi ou à l’activité durable, pour les publics qui en sont les plus éloignés : jeunes et demandeurs d’emplois peu ou pas qualifiés, habitant les quartiers de la politique de la ville, les territoires d’outre-mer ou des zones rurales enclavées, en particulier.',
      answer: '100 % inclusion, c’est un mot d’ordre au cœur de la politique du Gouvernement car nul n’est inemployable et nous devons accompagner les plus vulnérables dans la formation et l’accès à l’emploi. La France regorge sur notre territoire d’entrepreneurs sociaux, d’initiatives innovantes et de compétences, qui doivent permettre d’apporter des solutions à nos concitoyens.',
      author: {
  ...
  associations: [
    ...
    },
    {
      ...
      desc: 'La Cravate Solidaire est une association loi 1901 positionnée en bout de chaîne de l\'insertion : elle a pour objectif de lutter contre les discriminations à l\'embauche, notamment celles liées à l\'apparence.\n' +
