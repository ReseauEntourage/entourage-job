  ...
  if (search) {
    return {
      [Op.or]: [
        ...
        searchInColumnWhereOption('Opportunity.prerequesites', search),
        searchInColumnWhereOption('Opportunity.department', search),
        searchInColumnWhereOption('Opportunity.contract', search),
        searchInColumnWhereOption('Opportunity.startOfContract', search),
        searchInColumnWhereOption('Opportunity.endOfContract', search),
        searchInColumnWhereOption('Opportunity.message', search),
        searchInColumnWhereOption('Opportunity.date', search),
