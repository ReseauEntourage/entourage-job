  ...
  const content = [
      ...
      text: (
        <div>
          <span className="uk-text-bold">
            Nous vous aidons à réaliser un CV
          </span>{' '}
          plus humain, afin de valoriser vos atouts et de vous présenter tel que
          vous êtes
        </div>
      ),
    },
    {
      ...
      text: (
        <div>
          <span className="uk-text-bold">
            Vous rencontrez toutes les semaines votre bénévole-coach
          </span>{' '}
          pour travailler ensemble votre recherche d’emploi
        </div>
      ),
    },
    {
      ...
      text: (
        <div>
          Vous êtes soutenu(e){' '}
          <span className="uk-text-bold">
            lors de votre reprise d&apos;emploi
          </span>{' '}
          et durant les premiers mois de votre arrivée en entreprise
        </div>
      ),
    },
  ];
  ...
  return (
    <Section container="small" id="stepsToJoin" style="muted">
      <h2 className="uk-text-bold uk-align-center uk-text-center uk-margin-large-bottom uk-margin-remove-top">
        Quelles sont <span className="uk-text-primary">les étapes</span> du
        parcours LinkedOut ?
      </h2>
      <MultipleCTA data={content} showNumbers animate />
      <h4 className="uk-text-bold uk-text-center uk-margin-large-top">
        La promotion LinkedOut est complète pour 2020. Nous étudierons à nouveau
        les candidatures pour le lancement de la prochaine promotion en avril
        2021 à Paris, dans le 92, le 93 et à Lille.
      </h4>
