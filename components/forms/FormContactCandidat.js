    ...
    return (
      <Fragment>
        ...
        <div className="uk-flex uk-flex-right uk-width-1-1 uk-margin">
          ...
          <button className="uk-button uk-button-primary uk-margin-right" onClick={this.handleSubmit.bind(this)}>Envoyer</button>
          <button className="uk-button uk-button-default" name="cancel" onClick={() => UIkit.modal("#modalContactCandidat").hide()}>Annuler</button>
        </div>
      </Fragment>
    );
  }
