...
const CVPDF = ({cv}) => {
  const firstPage = {...cv};
  delete firstPage.story;
  delete firstPage.reviews;
  delete firstPage.skills;
  delete firstPage.passions;

  const secondPage = {...cv};
  delete secondPage.experiences;
  delete secondPage.contracts;
  delete secondPage.locations;
  delete secondPage.availability;
  delete secondPage.languages;
  delete secondPage.transport;
  ...
  return (
    <div className="uk-flex uk-flex-middle uk-flex-column">
      <div style={{
        ...
        <div id="cv-fiche" className="uk-padding uk-position-relative">
          <div className="uk-card uk-card-default uk-padding uk-background-default">
            <GridNoSSR childWidths={['1-1']} gap="small">
              <div className="uk-flex uk-flex-column uk-flex-middle uk-margin-small-bottom">
                <h2 className="uk-text-bold uk-text-primary">
