...
const AssociationEntourage = () => (
  <Background blend={{ colorHex: '#484848' }}>
    <Section className="uk-padding-remove-top">
      ...
      >
        <GridNoSSR middle center childWidths={['1-2@m']} className="uk-margin-large-top">
          <div>
            ...
            <div className="uk-light">
              <p className="uk-text-center uk-padding-small uk-text-secondary">
                Depuis 2016, l&apos;association Entourage engage la société civile à créer des relations durables et de proximité avec les personnes précaires pour leur permettre de participer à la vie de la société.
              </p>
