        ...
        {[
          {
            ...
            tag: isCVPage ? TAGS.PAGE_CV_SUIVRE_SUR_FACEBOOK_CLIC : TAGS.HOME_SUIVRE_SUR_FACEBOOK_CLIC
          },
          {
            name: 'twitter',
            title: 'Twitter',
            href: 'https://twitter.com/r_entourage/',
            tag: isCVPage ? TAGS.PAGE_CV_SUIVRE_SUR_TWITTER_CLIC : TAGS.HOME_SUIVRE_SUR_TWITTER_CLIC
          },
          {
            name: 'linkedin',
            title: 'LinkedIn',
            href: 'https://www.linkedin.com/company/association-entourage/',
            tag: isCVPage ? TAGS.PAGE_CV_SUIVRE_SUR_LINKEDIN_CLIC : TAGS.HOME_SUIVRE_SUR_LINKEDIN_CLIC
          },
